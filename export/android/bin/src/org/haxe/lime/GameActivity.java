...
public class GameActivity extends Activity implements SensorEventListener {
	...
	public static int getResourceID (String inFilename) {
		...
		//
		//if (inFilename.equals("assets/sounds/beep.ogg")) return test.TestProject.R.raw.assets_sounds_beep_ogg;
		//if (inFilename.equals("assets/sounds/flixel.ogg")) return test.TestProject.R.raw.assets_sounds_flixel_ogg;
		//
		return -1;
