...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("Madness"),HX_CSTRING("TestProject"),HX_CSTRING("test.TestProject"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",35,0x0780ded5)
			{
				...
				HX_STACK_LINE(64)
				{
					...
					HX_STACK_LINE(64)
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::test::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(64)
					while(((_g < _g1->length))){
						HX_STACK_LINE(64)
				...
				if ((hasMain)){
					HX_STACK_LINE(77)
					::Reflect_obj::callMethod(hx::ClassOf< ::test::Main >(),::Reflect_obj::field(hx::ClassOf< ::test::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(81)
		...
		HX_STACK_LINE(35)
		::openfl::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)488097,(int((int((int((int((int((int((int((int((int((int(::openfl::Lib_obj::HARDWARE) | int(::openfl::Lib_obj::ALLOW_SHADERS))) | int(::openfl::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("TestProject"),null(),null());
	}
return null();
}
