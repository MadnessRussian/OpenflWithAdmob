...
{
		HX_STACK_FRAME("openfl.display.Stage","__setActive",0xa87eb68e,"openfl.display.Stage.__setActive","openfl/display/Stage.hx",1030,0xadca4c2c)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((  (((focus->__get((int)0).StaticCast< ::openfl::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::openfl::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","openfl/display/Stage.hx",1056,0xadca4c2c)
						{
							HX_STACK_LINE(1056)
