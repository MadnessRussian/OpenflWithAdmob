...
{
HX_STACK_FRAME("openfl.net.URLRequest","new",0xe13767c1,"openfl.net.URLRequest.new","openfl/net/URLRequest.hx",31,0xe997cd0d)
HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLRequest","basicAuth",0x59f0fb57,"openfl.net.URLRequest.basicAuth","openfl/net/URLRequest.hx",52,0xe997cd0d)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("openfl.net.URLRequest","digestAuth",0xbd1f048b,"openfl.net.URLRequest.digestAuth","openfl/net/URLRequest.hx",60,0xe997cd0d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(user,"user")
		HX_STACK_ARG(password,"password")
		HX_STACK_LINE(62)
...
{
		HX_STACK_FRAME("openfl.net.URLRequest","__prepare",0xd0fcb888,"openfl.net.URLRequest.__prepare","openfl/net/URLRequest.hx",70,0xe997cd0d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(70)
		if (((this->data == null()))){
			HX_STACK_LINE(72)
